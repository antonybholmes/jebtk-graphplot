...
/**
 * A heatmap that allows for column and row swapping based
 * upon clustering.
 * 
...
public class ClusterHeatMapPlotElement extends HeatMapPlotElement {
	...
	/* (non-Javadoc)
	 * @see edu.columbia.rdf.lib.bioinformatics.plot.heatmap.HeatMapPlotElement#drawMatrix(java.awt.Graphics2D)
	 */
	@Override
