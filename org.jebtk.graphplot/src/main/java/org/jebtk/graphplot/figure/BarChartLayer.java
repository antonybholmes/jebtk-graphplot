...
public class BarChartLayer extends PlotClippedLayer {
	 ...
	 * @param h the h
	 */
	public static void patternFill(Graphics2D g2,
			FillPattern pattern,
			int x,
			int y,
			int w,
	 ...
	 * @param h the h
	 */
	public static void crossHatching(Graphics2D g2,
			int x,
			int y,
			int w,
			int h) {
	 ...
	 * @param h the h
	 */
	public static void forwardSlashHatching(Graphics2D g2,
			int x,
			int y,
			int w,
			int h) {
	 ...
	 * @param h the h
	 */
	public static void backSlashHatching(Graphics2D g2,
			int x,
			int y,
			int w,
			int h) {
	 ...
	 * @param h the h
	 */
	public static void hozHatching(Graphics2D g2,
			int x,
			int y,
			int w,
			int h) {
	 ...
	 * @param h the h
	 */
	public static void vertHatching(Graphics2D g2,
			int x,
			int y,
			int w,
			int h) {
