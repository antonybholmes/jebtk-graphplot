...
/**
 * The Y1 and Y2 labels are essentially the same accept for where the
...
public abstract class AxisLayerY extends AxesLayer {
	 ...
	 * @param x the x
	 */
	protected abstract void drawLabels(Graphics2D g2,
			Axis axis,
	 ...
	 * @param x the x
	 */
	protected static void drawLine(Graphics2D g2,
			Axes axes,
			Axis axis,
			int x) {
