...
public class Axis extends VisibleProperties
  ...
  /**
   * Returns an id describing properties of an axis. Comparing hashes can
   * indicate when an axis properties have changed.
   *
   * @return the string
   */
  @Override
  ...
  public static double calcStepSize(double range) {
     ...
     * 
     * // promote the MSD to either 1, 2, or 5 if (magMsd > 5.0) { magMsd =
     * 10.0f; } else if (magMsd > 2.0) { magMsd = 5.0f; } else if (magMsd > 1.0)
     * { magMsd = 2.0f; }
     * 
