 ...
 */
public class ZModel<T extends ZLayer> extends LayerCanvasListener implements Iterable<Integer>, ModernCanvasListener {
	...
	/**
	 * Returns the next available z between 1 and 999 inclusive. Z values
	 * outside this range are reserved and should not be used by plot layer.
	 *
