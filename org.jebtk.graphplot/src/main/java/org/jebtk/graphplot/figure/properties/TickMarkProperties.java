 ...
 *
 */
public class TickMarkProperties extends ChangeListeners implements Iterable<Double>, ChangeListener {
	...
	/**
	 * Returns a copy of the tick positions. Use the update/set methods
	 * to adjust the tick positions.
	 *
	 * @return the ticks
	 */
	...
	/**
	 * Set the tick labels. If labels exceeds the length of the ticks,
	...
	/**
	 * Set the tick labels. If labels is too short, tick labels will be
	 * padded with empty strings. If labels is too long, elements
	 * exceeding the number of ticks will be ignored.
	 *
	...
	public void setLabels(Collection<String> labels) {
		...
		mLabels = CollectionUtils.pad(labels, TextUtils.EMPTY_STRING, mTicks.size());
