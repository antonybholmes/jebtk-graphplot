...
public class BoxWhiskerSummary extends XYSeries {
  ...
  public BoxWhiskerSummary(DataFrame m, XYSeries series) {
    ...
    System.err.println("box whisker " + mMedian + " " + mQ1 + " " + mQ3 + " "
        + mLower + " " + mUpper);
   ...
   */
  /*
   * public BoxWhiskerSummary(XYSeries series, double mean, double median,
   * double q1, double q3, double upper, double lower) {
