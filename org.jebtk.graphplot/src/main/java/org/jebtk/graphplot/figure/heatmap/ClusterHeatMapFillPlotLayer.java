  ...
  protected void cache(DrawingContext context,
    ...
    if (mHashId == null || !mHashId.equals(subFigure.hashId())) {
      ...
      for (int i = 0; i < m.getRows(); ++i) {
        ...
        System.err.println("add y " + i + " " + y + " " + y1 + " "
            + axes.getInternalSize() + " " + axes.toPlotY1(m.getRows() - 1)
            + " " + axes.toPlotY1(0));
    ...
    if (mColorMap == null || !plot.getColorMap().equals(mColorMap) || mM == null
        || !m.equals(mM) || mHashId == null
