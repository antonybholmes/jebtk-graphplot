 ...
 */
public class LocationModel<T extends ZLayer> extends LayerCanvasListener implements Iterable<GridLocation>, ModernCanvasListener {
	 ...
	 * The member name map.
	 */
	private Map<GridLocation, ZModel<T>> mLayoutMap = 
			new HashMap<GridLocation, ZModel<T>>();
