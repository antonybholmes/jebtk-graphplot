...
public class XYPoint extends ChangeListeners implements ChangeListener {
	 ...
	 */
	/*
	public static boolean withinGraphBounds(XYPoint point,
			AxisProperties xAxis, AxisProperties yAxis) {
		return point.getX() >= xAxis.getMin() && 
				point.getX() <= xAxis.getMax() &&
				point.getY() >= yAxis.getMin() &&
