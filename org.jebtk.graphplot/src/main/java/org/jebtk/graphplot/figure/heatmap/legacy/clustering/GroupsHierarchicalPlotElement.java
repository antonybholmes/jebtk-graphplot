...
public class GroupsHierarchicalPlotElement extends MatrixPlotElement {
   ...
   */
  public GroupsHierarchicalPlotElement(DataFrame matrix, DoubleDim aspectRatio,
      int width, Cluster rootCluster, XYSeriesGroup groups) {
    ...
    List<List<Integer>> indices = XYSeriesGroup.findColumnIndices(matrix,
        groups);
