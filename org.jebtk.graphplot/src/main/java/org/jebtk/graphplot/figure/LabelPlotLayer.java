...
public class LabelPlotLayer extends PlotLayer {
   ...
   */
  public LabelPlotLayer(String name, double x, double y, int offsetXPixels,
      int offsetYPixels) {
   ...
   */
  public LabelPlotLayer(String name, double x, double y, boolean centerX,
      boolean centerY) {
   ...
   */
  public LabelPlotLayer(String name, double x, double y, boolean centerX,
      boolean centerY, int offsetXPixels, int offsetYPixels) {
    this(name, x, y, centerX, centerY, offsetXPixels, offsetYPixels,
        Color.BLACK);
  }
   ...
   */
  public LabelPlotLayer(String name, double x, double y, boolean centerX,
      boolean centerY, int offsetXPixels, int offsetYPixels, Color color) {
    mLabel = name;
    mX = x;
    mY = y;
    mCenterX = centerX;
