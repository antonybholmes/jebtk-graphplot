...
public class PlotFactory {
  ...
  public static void createBarPlot(DataFrame m,
    ...
    axes.getX1Axis().getTicks().getMajorTicks().getLineStyle()
        .setVisible(false);
    axes.getX1Axis().getTicks().getMinorTicks().getLineStyle()
        .setVisible(false);
  ...
  public static void createBarPlotH(DataFrame m,
    ...
    axes.getY1Axis().getTicks().getMajorTicks().getLineStyle()
        .setVisible(false);
    axes.getY1Axis().getTicks().getMinorTicks().getLineStyle()
        .setVisible(false);
  ...
  public static void createStackedBarPlot(DataFrame m,
    ...
    axes.getX1Axis().getTicks()
        .setTicks(Linspace.evenlySpaced(0.5, n - 0.5, 1));
  ...
  public static void createHistogram(DataFrame m,
    ...
    axes.getX1Axis().setLimitsAutoRound(0,
        hist[hist.length - 1].getX() + hist[hist.length - 1].getWidth());
  ...
  public static void createPiePlot(DataFrame m,
    ...
    axes.getX1Axis().getTicks().getMinorTicks().getLineStyle()
        .setVisible(false);
    axes.getX1Axis().getTicks().getMinorTicks().getFontStyle()
        .setVisible(false);

    axes.getY1Axis().getLineStyle().setVisible(false);
    axes.getY1Axis().getTicks().getMajorTicks().getLineStyle()
        .setVisible(false);
    axes.getY1Axis().getTicks().getMajorTicks().getFontStyle()
        .setVisible(false);
    axes.getY1Axis().getTicks().getMinorTicks().getLineStyle()
        .setVisible(false);
    axes.getY1Axis().getTicks().getMinorTicks().getFontStyle()
        .setVisible(false);
  ...
  public static void createBoxWhiskerSummaryPlot(DataFrame m,
    ...
    axes.getX1Axis().getTicks()
        .setTicks(Linspace.evenlySpaced(0.5, series.getCount() - 0.5, 1));
  ...
  public static void createBoxWhiskerPlot(DataFrame m,
    ...
    for (XYSeries series : seriesGroup) {
      ...
      plot.addChild(
          new BoxWhiskerScatterLayer(summary.getName(), x, showScatter));
  ...
  private static void formatBoxWhiskerAxes(DataFrame m,
    ...
    axes.setInternalSize(boxWhiskers.getCount() * BOX_WHISKER_WIDTH,
        Axes.DEFAULT_SIZE.getH());

    axes.getX1Axis().setLimits(0, boxWhiskers.getCount());
    axes.getX1Axis().getTicks()
        .setTicks(Linspace.evenlySpaced(0.5, boxWhiskers.getCount(), 1));
  ...
  public static void createClusterHeatMap(DataFrame m,
    ...
    if (columnCluster != null) {
      ...
      plot.setMatrix(m);
      plot.addChild(
          new ColumnHierarchicalTreeLayer(columnCluster, Color.BLACK, 100));
  ...
  private static void createHeatMapCommon(DataFrame m,
    ...
    boolean fullView = axes.getInternalSize().getW() >= m.getCols()
        * DEFAULT_HEATMAP_SIZE;

    axes.getX1Axis().setLimits(0, m.getCols(), 1);
    axes.getX1Axis().getTicks()
        .setTicks(Linspace.evenlySpaced(0.5, m.getCols() - 0.5, 1));
    ...
    fullView = axes.getInternalSize().getH() >= m.getRows()
        * DEFAULT_HEATMAP_SIZE;
    ...
    axes.getY2Axis().getTicks().getMinorTicks().getLineStyle()
        .setVisible(false);
  ...
  public static int autoSetX1LabelMargin(Axes axes) {
    ...
    if (axes.getX1Axis().getVisible()) {
      String text = TextUtils
          .maxString(axes.getX1Axis().getTicks().getMajorTicks().getLabels());

      w = ModernWidget.getStringWidth(
          axes.getX1Axis().getTicks().getMajorTicks().getFontStyle().getFont(),
          text);
  ...
  public static int autoSetY1LabelMargin(Axes axes) {
    ...
    if (axes.getY1Axis().getVisible()) {
      String text = TextUtils
          .maxString(axes.getY1Axis().getTicks().getMajorTicks().getLabels());

      w = ModernWidget.getStringWidth(
          axes.getY1Axis().getTicks().getMajorTicks().getFontStyle().getFont(),
          text);
    }
  ...
  public static int autoSetY2LabelMargin(Axes axes) {
    ...
    String text = TextUtils
        .maxString(axes.getY2Axis().getTicks().getMajorTicks().getLabels());

    w = ModernWidget.getStringWidth(
        axes.getY2Axis().getTicks().getMajorTicks().getFontStyle().getFont(),
        text);
