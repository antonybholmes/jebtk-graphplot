...
public class Image {
   ...
   */
  public static void translateSvg(ModernCanvas canvas, Path file)
      throws IOException {
  ...
  public static void translateSvg(PlotBox canvas, Path file)
      throws IOException {
   ...
   */
  public static void translatePng(ModernCanvas canvas, Path file)
   ...
   * @throws TranscoderException the transcoder exception
   */
  public static void translatePdf(ModernCanvas canvas, Path file)
      throws IOException, TranscoderException {
  ...
  public static void translatePdf(PlotBox canvas, Path file)
      throws IOException, TranscoderException {
    Transcoder trans = new PDFTranscoder();
   ...
   * @throws IOException Signals that an I/O exception has occurred.
   */
  public static void writePng(ModernCanvas canvas, Path file)
      throws IOException {
   ...
   * @throws IOException Signals that an I/O exception has occurred.
   */
  public static void writeJpg(ModernCanvas canvas, Path file)
      throws IOException {
   ...
   * @throws IOException Signals that an I/O exception has occurred.
   */
  public static void write(ModernCanvas canvas, Path file, String type)
      throws IOException {
    IntDim d = canvas.getAbsPreferredSize();

    BufferedImage bufferedImage;

    System.err.println("png " + canvas.getPreferredSize() + " "
        + canvas.getAbsPreferredSize());

    if (type.equals("png")) {
      bufferedImage = new BufferedImage(d.getW(), d.getH(),
  ...
  public static void write(PlotBox canvas, Path file, String type)
      throws IOException {
    Dimension d = canvas.getPreferredSize();
    ...
    if (type.equals("png")) {
      bufferedImage = new BufferedImage(d.width, d.height,
          BufferedImage.TYPE_INT_ARGB);
    } else {
      bufferedImage = new BufferedImage(d.width, d.height,
          BufferedImage.TYPE_INT_RGB);
   ...
   * @throws TranscoderException the transcoder exception
   */
  public static void write(ModernCanvas canvas, Path file)
      throws IOException, TranscoderException {
  ...
  public static void write(PlotBox canvas, Path file)
      throws IOException, TranscoderException {
    String ext = PathUtils.getFileExt(file);
   ...
   * @throws IOException Signals that an I/O exception has occurred.
   */
  public static void writeEps(ModernCanvas canvas, Path file)
      throws IOException {
